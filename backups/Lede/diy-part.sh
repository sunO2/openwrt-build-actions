...
export Op_name="HomeStation-OpenWrt"                # 修改主机名称为OpenWrt-123(填0为不作修改)
...
export DNS_Settings="192.168.0.1 114.114.114.114"                     # 旁路由设置 DNS(填入DNS，多个DNS要用空格分开)(填0为不作修改)
export Broadcast_Ipv4="192.168.0.255"                   # 设置 IPv4 广播(填入您的IP为启用)(填0为不作修改)
